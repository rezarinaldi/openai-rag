...
collection.add(documents=fruit_strings, ids=[str(i) for i in range(len(fruit_strings))])

# collection = client.get_collection("fruits", embedding_function=openai_ef)

# result = collection.query(
#     query_texts=["Is banana yellow?"], n_results=20, include=["distances", "documents"]
# )
